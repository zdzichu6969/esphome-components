...
CONF_ENERGY_TODAY = "energy_production_today"
CONF_ENERGY_YESTERDAY = "energy_production_yesterday"
CONF_ENERGY_WEEK = "energy_production_week"
CONF_ENERGY_MONTH = "energy_production_month"

energy_statistics_ns = cg.esphome_ns.namespace("energy_production_statistics")
...
async def to_code(config):
    ...
    await setup_sensor(config, CONF_ENERGY_MONTH, var.set_energy_production_month)
